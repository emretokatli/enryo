    ...
    <div className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl px-4 animate-fade-in">
        <div className="bg-white/10 backdrop-blur-sm p-2 inline-block rounded-full mb-3">
          <span className="text-xs font-medium text-white px-3 py-1 bg-brand rounded-full">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button variant="outline" className="h-12 px-6 text-base font-medium bg-white/10 text-white border-white/20 hover:bg-white/20 transition-all">
            View Special Offers
          </Button>
        </div>
      </div>
